            ...
            text-shadow: 0px 1px 1px rgba(0, 0, 0, 0.15);">
                ...
                @auth           
                    ...
                    <a class="nav-link dropdown-toggle" href="#" id="navbarDropdown" role="button" data-bs-toggle="dropdown" aria-expanded="false">
                        Welcome back, {{ auth()->user()->name }}      {{-- Mengambil data user yg sudah login / authentication --}}
                    </a>
                ...
                {{-- Apabila belum melakukan login / authentication --}}
                @else
                {{-- Nav untuk login apabila user belum melakukan authentication--}}
                    <li class="nav-item">
