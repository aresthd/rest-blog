...
@section('container')
    ...
    <div class="col-lg-8">
        {{-- Form untuk menambah data post yg datanya akan dikirim ke route /dashboard/categories/{{ $category->slug } dengan metode post dan akan diterima oleh method store di controller DashboardPostControlller.php --}}
        <form method="POST" action="/dashboard/categories/{{ $category->id }}" class="mb-5" enctype="multipart/form-data">       {{-- enctype ~> Berfungsi agar dapat mengupload file --}}
    ...
    <script>
        ...
        title.addEventListener('change', function() {
            ...
            // Apabila ada request ke /dashboard/categories/checkSlug dan mengirim data title
